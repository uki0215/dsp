<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg px-0 shadow-none border-radius-xl bg-white" id="navbarBlur"
    navbar-scroll="false">
    <div class="container-fluid py-1 px-3">
        ...
        <div class="mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
            <!--<div class="ms-md-5 pe-md-5 d-flex align-items-center">
