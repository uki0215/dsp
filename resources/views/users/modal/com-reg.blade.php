                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="@error('ownerName') @enderror">
                                <input class="form-control" value="Б.Сийлэгмаа" type="text" id="ownerName"
                                    name="ownerName">
                                @error('ownerName')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="@error('price') @enderror">
                                <input class="form-control" value="1,258,000" type="text" id="price"
                                    name="price">
                                @error('price')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="@error('comment') @enderror">
                                <textarea class="form-control" value="SJ58752" type="text" id="comment" name="comment"></textarea>
                                @error('comment')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
